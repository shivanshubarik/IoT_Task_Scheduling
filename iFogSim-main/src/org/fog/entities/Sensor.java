...
public class Sensor extends SimEntity{
     ...
     * @param userId ID of the user/application owner
     * @param appId ID of the application
     * @param tupleType Type of tuple generated by this sensor
     * @param transmitDistribution Distribution object controlling tuple transmission
     */

    // Constructor for JSON/topology-based creation
    public Sensor(String name, int userId, String appId, String tupleType, Distribution transmitDistribution) {
        super(name);
        this.setAppId(appId);
        this.setTransmitDistribution(transmitDistribution);
        setTupleType(tupleType);
    ...
    // Constructor with DeterministicDistribution
    public Sensor(String name, String tupleType, int userId, String appId, DeterministicDistribution transmitDistribution) {
        super(name);
        this.setAppId(appId);
        this.setTransmitDistribution(transmitDistribution);
        setTupleType(tupleType);
